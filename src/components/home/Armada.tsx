  ...
  return (
    <section className="py-24 bg-paper sm:py-32">
      <div className="px-6 mx-auto max-w-7xl lg:px-8">
        <Reveal>
          <div className="mb-14">
            <p className="mb-3 text-xs font-semibold uppercase tracking-[0.3em] text-gold-600">Armada Kami</p>
            <h2 className="font-display text-4xl font-normal tracking-tight text-ink-900 md:text-6xl">
              Showroom
              <span className="block italic text-gold-600">Kendaraan Pilihan</span>
            </h2>
          </div>
        </Reveal>
