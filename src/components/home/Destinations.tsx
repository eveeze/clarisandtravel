      ...
      <div className="px-6 mx-auto max-w-7xl lg:px-8">
        <Reveal>
          <div className="flex flex-wrap items-end justify-between gap-4 mb-14">
            ...
            <Link href="/tourist-destination" className="text-sm font-semibold text-gold-600 hover:underline">
              Semua Destinasi →
            </Link>
          </div>
        </Reveal>
              ...
              <Reveal key={spot.id} delay={i * 60}>
                ...
                >
                  ...
                  <div className="absolute bottom-0 p-6">
                    <p className="mb-1 text-[10px] font-semibold uppercase tracking-[0.25em] text-gold-600">
                      {spot.category}
                    </p>
                    <h3 className="font-display text-2xl text-ink-900">{spot.name}</h3>
                  </div>
                </div>
              </Reveal>
            );
