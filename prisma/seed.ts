  ...
  const siteContent = [
    ...
    },
    {
      ...
      content: {
        ...
        items: [
          { title: "Jalur Paling Tahu", description: "Bukan rute turis mainstream. Kami tau jalur sepi, spot foto rahasia, dan warung makan yang cuma anak Jogja yang tau." },
          { title: "Waktumu Fleksibel", description: "Pengen bangun siang? No problem. Itinerary kami sesuaikan ritme liburanmu, bukan sebaliknya." },
          { title: "Satu Kontak Semua Urusan", description: "Penjemputan, tiket, itinerary, sampe rekomendasi oleh-oleh — semua diurus satu tim, gak bolak-balik nelpon sana-sini." },
          { title: "Harga Apa Adanya", description: "Gak ada biaya 'bensin tambahan' mendadak atau harga mendadak naik pas udah jalan. Yang dijelasin di awal, itu yang lo bayar." },
        ],
      },
    },
    {
